...
class VideoCapture(QWidget):
    def __init__(self, filename, parent):
        ...
        print("VideoCapture.init inside")
    ...
    def start(self):
        ...
        print("VideoCapture.start inside")
...
class VideoDisplayWidget(QWidget):
    def __init__(self,parent):
        ...
        print("VideoDisplayWidget.start inside")
...
class ControlWindow(QMainWindow):
    def __init__(self):
        ...
        print("ControlWindow.start inside")
    ...
    def closeApplication(self):
        choice = QtWidgets.QMessageBox.question(self, 'Message','Do you really want to exit?',QtGui.QMessageBox.Yes | QtGui.QMessageBox.No)
